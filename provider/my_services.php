				...
				<div class="row">
					...
					<div class="col-xl-9 col-md-8">
						...
						<div class="row">
							...
							$provider_member_query = "SELECT * FROM `provider_member` WHERE pid=$id AND status='active'";
									...
									<div class="service-content">
										...
										<div class="user-info">
											<div class="service-action">
												<div class="row">
													<div class="col">
														<a href="process/active_inactive_service.php?p_m_id=<?php echo $row['p_m_id']?>" class="text-success"><i class="far fa-edit"></i>Inactive</a>
													</div>
...
<!-- Mirrored from truelysell-html.dreamguystech.com/template/my-services.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 26 Jun 2021 08:10:35 GMT -->
</html>