...
if(isset($_GET['bid']))
{
	...
	$sql1 = "UPDATE `service_booking` SET `status`='cancel',`customer_cancel_time`='$timestamp' WHERE bid='$bid'";
	...
	if($query)
	{
		...
		alert('Successfully cancel the service request. Your Money will be Return.');
